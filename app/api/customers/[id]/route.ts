...
import { canEditCustomerProfile } from "@/lib/customer-access";
...
export async function PATCH(
  ...
  try {
    ...
    const collaboratorIds = existing.ownerId === user.id || user.role.code === "ADMIN" || user.role.code === "SALES_MANAGER"
